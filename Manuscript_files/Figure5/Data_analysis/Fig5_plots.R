...
uTARs<- grep("^chr", m$gene)
uTARs <- m2[uTARs, ]
cuTARs <- subset(uTARs, pval > 0.05 | pval < -0.05)
uTARs<-uTARs$gene
manhattan1(m2, chr = "chr", bp = "start", p = "Log2FC", snp = "gene",col = c("#e5e4e2", "#bebebe"),highlight1 = uTARs, highlight2 = cuTARs, logp = FALSE,ylim=c(-8,8), ylab="average log2FC",suggestiveline = F, genomewideline = F)
